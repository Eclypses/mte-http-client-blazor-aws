...
(function (MteStatus) {
    ...
    /** Status codes. */
    /** No error occurred. */
    MteStatus[MteStatus["mte_status_success"] = 0] = "mte_status_success";
    /** Invalid input. */
    MteStatus[MteStatus["mte_status_invalid_input"] = 1] = "mte_status_invalid_input";
    /** Unsupported operation. */
    MteStatus[MteStatus["mte_status_unsupported"] = 2] = "mte_status_unsupported";
    /** A normal DRBG error occurred. NIST SP 800-90A section 9. */
    MteStatus[MteStatus["mte_status_drbg_error"] = 3] = "mte_status_drbg_error";
    /** A catastrophic DRBG error occurred. NIST SP 800-90A section 9. */
    MteStatus[MteStatus["mte_status_drbg_catastrophic"] = 4] = "mte_status_drbg_catastrophic";
    /** The seedlife has been reached. NIST SP 800-90A section 9.3.1. */
    MteStatus[MteStatus["mte_status_drbg_seedlife_reached"] = 5] = "mte_status_drbg_seedlife_reached";
    /** A cipher algorithm self-test failed. */
    MteStatus[MteStatus["mte_status_cipher_test_failed"] = 6] = "mte_status_cipher_test_failed";
    /** A hash algorithm self-test failed. */
    MteStatus[MteStatus["mte_status_hash_test_failed"] = 7] = "mte_status_hash_test_failed";
    /** Output is inhibited due to an error state or self-test. */
    MteStatus[MteStatus["mte_status_output_inhibited"] = 8] = "mte_status_output_inhibited";
    /** Implementation error. */
    MteStatus[MteStatus["mte_status_impl_error"] = 9] = "mte_status_impl_error";
    /** License error. */
    MteStatus[MteStatus["mte_status_license_error"] = 10] = "mte_status_license_error";
    /** No such token exists. */
    MteStatus[MteStatus["mte_status_token_does_not_exist"] = 11] = "mte_status_token_does_not_exist";
    /** Checksum mismatch. */
    MteStatus[MteStatus["mte_status_checksum_mismatch"] = 12] = "mte_status_checksum_mismatch";
    /** Hash digest mismatch. */
    MteStatus[MteStatus["mte_status_digest_mismatch"] = 13] = "mte_status_digest_mismatch";
    /** The message was received too long before/after it was sent. */
    MteStatus[MteStatus["mte_status_time_before_exceeded"] = 14] = "mte_status_time_before_exceeded";
    MteStatus[MteStatus["mte_status_time_after_exceeded"] = 15] = "mte_status_time_after_exceeded";
    /** The sequence number is outside the window. */
    MteStatus[MteStatus["mte_status_seq_outside_window"] = 16] = "mte_status_seq_outside_window";
    /** The sequence number has already been seen in async mode. */
    MteStatus[MteStatus["mte_status_seq_async_replay"] = 17] = "mte_status_seq_async_replay";
    ...
    /** message arrived. */
    MteStatus[MteStatus["mte_status_seq_mismatch"] = 18] = "mte_status_seq_mismatch";
})(MteStatus || (MteStatus = {}));
/** DRBGs. */
export var MteDrbgs;
(function (MteDrbgs) {
    ...
    MteDrbgs[MteDrbgs["mte_drbgs_none"] = 0] = "mte_drbgs_none";
    /** Increment. The next "random" number is one more than the previous. */
    /** This provides no security and is meant for testing only. */
    MteDrbgs[MteDrbgs["mte_drbgs_increment"] = 1] = "mte_drbgs_increment";
    /** NIST CTR DRBG using AES-128 with derivation function. */
    MteDrbgs[MteDrbgs["mte_drbgs_ctr_aes128_df"] = 2] = "mte_drbgs_ctr_aes128_df";
    /** NIST CTR DRBG using AES-128 with no derivation function. */
    MteDrbgs[MteDrbgs["mte_drbgs_ctr_aes128_nodf"] = 3] = "mte_drbgs_ctr_aes128_nodf";
    /** NIST CTR DRBG using AES-192 with derivation function. */
    MteDrbgs[MteDrbgs["mte_drbgs_ctr_aes192_df"] = 4] = "mte_drbgs_ctr_aes192_df";
    /** NIST CTR DRBG using AES-192 with no derivation function. */
    MteDrbgs[MteDrbgs["mte_drbgs_ctr_aes192_nodf"] = 5] = "mte_drbgs_ctr_aes192_nodf";
    /** NIST CTR DRBG using AES-256 with derivation function. */
    MteDrbgs[MteDrbgs["mte_drbgs_ctr_aes256_df"] = 6] = "mte_drbgs_ctr_aes256_df";
    /** NIST CTR DRBG using AES-256 with no derivation function. */
    MteDrbgs[MteDrbgs["mte_drbgs_ctr_aes256_nodf"] = 7] = "mte_drbgs_ctr_aes256_nodf";
    /** NIST Hash DRBG using SHA-1. */
    MteDrbgs[MteDrbgs["mte_drbgs_hash_sha1"] = 8] = "mte_drbgs_hash_sha1";
    /** NIST Hash DRBG using SHA-256. */
    MteDrbgs[MteDrbgs["mte_drbgs_hash_sha256"] = 9] = "mte_drbgs_hash_sha256";
    /** NIST Hash DRBG using SHA-512. */
    MteDrbgs[MteDrbgs["mte_drbgs_hash_sha512"] = 10] = "mte_drbgs_hash_sha512";
})(MteDrbgs || (MteDrbgs = {}));
/** Verifiers. */
export var MteVerifiers;
(function (MteVerifiers) {
    /** Copyright (c) Eclypses, Inc. */
    /**  */
    /** All rights reserved. */
    /**  */
    ...
    /** Message verifiers. */
    /** None. */
    MteVerifiers[MteVerifiers["mte_verifiers_none"] = 0] = "mte_verifiers_none";
    /** CRC-32 checksum of data. */
    MteVerifiers[MteVerifiers["mte_verifiers_crc32"] = 1] = "mte_verifiers_crc32";
    /** CRC-32 checksum of data and sequencing. */
    MteVerifiers[MteVerifiers["mte_verifiers_crc32_seq"] = 2] = "mte_verifiers_crc32_seq";
    /** Sequencing. */
    MteVerifiers[MteVerifiers["mte_verifiers_seq"] = 3] = "mte_verifiers_seq";
    /** 64-bit timestamp. */
    MteVerifiers[MteVerifiers["mte_verifiers_t64"] = 4] = "mte_verifiers_t64";
    /** 64-bit timestamp and CRC-32 checksum of data and timestamp. */
    MteVerifiers[MteVerifiers["mte_verifiers_t64_crc32"] = 5] = "mte_verifiers_t64_crc32";
    /** 64-bit timestamp, CRC-32 checksum of data and timestamp, and */
    /** sequencing. */
    MteVerifiers[MteVerifiers["mte_verifiers_t64_crc32_seq"] = 6] = "mte_verifiers_t64_crc32_seq";
    /** 64-bit timestamp and sequencing. */
    MteVerifiers[MteVerifiers["mte_verifiers_t64_seq"] = 7] = "mte_verifiers_t64_seq";
})(MteVerifiers || (MteVerifiers = {}));
/** Ciphers. */
export var MteCiphers;
(function (MteCiphers) {
    /** Copyright (c) Eclypses, Inc. */
    /**  */
    /** All rights reserved. */
    ...
    MteCiphers[MteCiphers["mte_ciphers_none"] = 0] = "mte_ciphers_none";
    /** AES-128-CTR. */
    MteCiphers[MteCiphers["mte_ciphers_aes128_ctr"] = 1] = "mte_ciphers_aes128_ctr";
    /** AES-192-CTR. */
    MteCiphers[MteCiphers["mte_ciphers_aes192_ctr"] = 2] = "mte_ciphers_aes192_ctr";
    /** AES-256-CTR. */
    MteCiphers[MteCiphers["mte_ciphers_aes256_ctr"] = 3] = "mte_ciphers_aes256_ctr";
})(MteCiphers || (MteCiphers = {}));
/** Hashes. */
export var MteHashes;
(function (MteHashes) {
    /** Copyright (c) Eclypses, Inc. */
    /**  */
    /** All rights reserved. */
    ...
    MteHashes[MteHashes["mte_hashes_none"] = 0] = "mte_hashes_none";
    /** CRC-32 */
    MteHashes[MteHashes["mte_hashes_crc32"] = 1] = "mte_hashes_crc32";
    /** SHA-1 */
    MteHashes[MteHashes["mte_hashes_sha1"] = 2] = "mte_hashes_sha1";
    /** SHA-256 */
    MteHashes[MteHashes["mte_hashes_sha256"] = 3] = "mte_hashes_sha256";
    /** SHA-512 */
    MteHashes[MteHashes["mte_hashes_sha512"] = 4] = "mte_hashes_sha512";
})(MteHashes || (MteHashes = {}));
/** Init info. */
export var MteInitInfo;
(function (MteInitInfo) {
    /** Copyright (c) Eclypses, Inc. */
    /**  */
    /** All rights reserved. */
    /**  */
    ...
    MteInitInfo[MteInitInfo["mte_init_info_arm64_aes_paa"] = 0] = "mte_init_info_arm64_aes_paa";
    /** ARM64: is the SHA-1 extension present? Return 0 if not or non-zero */
    /**        if it is. This is only requested if it wasn't able to be */
    /**        determined automatically. */
    MteInitInfo[MteInitInfo["mte_init_info_arm64_sha1_paa"] = 1] = "mte_init_info_arm64_sha1_paa";
    /** ARM64: is the SHA-256 extension present? Return 0 if not or non-zero */
    /**        if it is. This is only requested if it wasn't able to be */
    /**        determined automatically. */
    MteInitInfo[MteInitInfo["mte_init_info_arm64_sha256_paa"] = 2] = "mte_init_info_arm64_sha256_paa";
    /** ARM64: is the SHA-512 extension present? Return 0 if not or non-zero */
    /**        if it is. This is only requested if it wasn't able to be */
    /**        determined automatically. */
    MteInitInfo[MteInitInfo["mte_init_info_arm64_sha512_paa"] = 3] = "mte_init_info_arm64_sha512_paa";
    /** ARM64: is the CRC-32 extension present? Return 0 if not or non-zero */
    /**        if it is. This is only requested if it wasn't able to be */
    /**        determined automatically. */
    MteInitInfo[MteInitInfo["mte_init_info_arm64_crc32_paa"] = 4] = "mte_init_info_arm64_crc32_paa";
})(MteInitInfo || (MteInitInfo = {}));
...
export class MteBase {
    ...
    constructor(wasm) {
        /** Options. */
        this.drbg = MteDrbgs.mte_drbgs_none;
        this.tokBytes = 0;
        this.verifiers = MteVerifiers.mte_verifiers_none;
        this.cipher = MteCiphers.mte_ciphers_none;
        this.hash_ = MteHashes.mte_hashes_none;
        /** Instantiation inputs. */
        this.entropyInput = new MteMem();
        this.nonce = null;
        /** Nonce length when set as an integer. */
        this.nonceIntBytes = 0;
        /** Callback overrides. */
        this.eiCallback = null;
        this.nCallback = null;
        this.tsCallback = null;
        /** Initialize. Derived classes must call this from their constructor. */
        this.initBase = (drbg, tokBytes, verifiers, cipher, hash_) => {
            // Set options.
            this.drbg = drbg;
            ...
            // DRBG.
            this.nonceIntBytes = Math.max(this.getDrbgsNonceMinBytes(drbg), Math.min(8, this.getDrbgsNonceMaxBytes(drbg)));
        };
        ...
        this.initLicense = (company, license) => {
        ...
        this.getDrbgsSecStrengthBytes = (algo) => {
         ...
         *  algorithm. */
        this.getDrbgsPersonalMinBytes = (algo) => {
        ...
        this.getCiphersBlockBytes = (algo) => {
        ...
        this.setEntropyArr = (entropyInput) => {
            // Copy to WASM memory.
            this.wasm.free(this.entropyInput);
         ...
         *  only. */
        this.setEntropyStr = (entropyInput) => {
         ...
         *  WARNING: the entropy is not zeroized because a 'string' object is read-
         *  only. */
        this.setEntropyB64 = (entropyInput) => {
        ...
        this.setTimestampCallback = (cb) => {
            this.tsCallback = cb;
        };
        /** The entropy callback. */
        this.entropyCallback = (context, minEntropy, minLength, maxLength, entropyInput, eiBytes) => {
            // Get the MTE instance.
            const theThis = MteBase.instances[context];
            // Call the override callback if set.
            if (theThis.eiCallback) {
                return theThis.eiCallback.entropyCallback(minEntropy, minLength, maxLength, entropyInput, eiBytes);
            }
            // Check the length.
        ...
        /** Timestamp callback. */
        this.timestampCallback = (context, tsOff) => {
            // Get the MTE instance.
            const theThis = MteBase.instances[context];
...
export class MteEnc extends MteBase {
     ...
     *  algorithm. */
    constructor(wasm, drbg, tokBytes, verifiers) {
        // Super.
        super(wasm);
        ...
        this.destruct = () => {
            this.destructBase();
            this.wasm.free(this.encoder);
            this.encoder.invalidate();
            this.wasm.free(this.saved);
            this.saved.invalidate();
            this.wasm.free(this.saved64);
            this.saved64.invalidate();
        };
        ...
        this.instantiate = (ps) => {
            ...
            // Instantiate.
            const ret = this.exports.mte_wasm_enc_instantiate(this.encoder.off, this.instance, this.instance, psWasm.off, psWasm.used);
        ...
        this.saveState = () => {
            ...
            const status = this.exports.mte_enc_state_save(this.encoder.off, this.saved.off);
        ...
        this.saveStateB64 = () => {
            ...
            const status = this.exports.mte_wasm_enc_state_save_b64(this.encoder.off, this.saved64.off);
            return status == MteStatus.mte_status_success ?
        ...
        this.restoreStateB64 = (saved) => {
            // Copy to the WASM memory.
            const stateWasm = this.wasm.strToWasm(saved);
            // Restore.
            const status = this.exports.mte_wasm_enc_state_restore_b64(this.encoder.off, stateWasm.off);
        ...
        this.encode = (data) => {
            ...
            const bytes = this.exports.mte_enc_buff_bytes(this.encoder.off, data.length);
            const encBuff = this.wasm.malloc(bytes);
            const eOff = this.wasm.newInt();
            const eBytes = this.wasm.newInt();
            // Encode.
            const ret = this.exports.mte_wasm_enc_encode(this.encoder.off, this.instance, wdata.off, data.length, encBuff.off, eOff.off, eBytes.off);
        ...
        this.encodeB64 = (data) => {
            ...
            const wdata = this.wasm.arrToWasm(data);
            // Allocate the encoder buffers.
            const bytes = this.exports.mte_wasm_enc_buff_bytes_b64(this.encoder.off, data.length);
            const encBuff = this.wasm.malloc(bytes);
            const eOff = this.wasm.newInt();
            const eBytes = this.wasm.newInt();
            // Encode.
            const ret = this.exports.mte_wasm_enc_encode_b64(this.encoder.off, this.instance, wdata.off, data.length, encBuff.off, eOff.off, eBytes.off);
            if (ret != MteStatus.mte_status_success) {
                this.wasm.free(wdata);
                this.wasm.free(encBuff);
                this.wasm.free(eOff);
        ...
        this.encodeStr = (str) => {
            ...
            // Allocate the encoder buffers.
            const bytes = this.exports.mte_enc_buff_bytes(this.encoder.off, wdata.used);
            const encBuff = this.wasm.malloc(bytes);
            const eOff = this.wasm.newInt();
            const eBytes = this.wasm.newInt();
            // Encode.
            const ret = this.exports.mte_wasm_enc_encode(this.encoder.off, this.instance, wdata.off, wdata.used, encBuff.off, eOff.off, eBytes.off);
            if (ret != MteStatus.mte_status_success) {
                this.wasm.free(wdata);
                this.wasm.free(encBuff);
                this.wasm.free(eOff);
         ...
         *  status. */
        this.encodeStrB64 = (str) => {
            // Convert the string to the WASM memory.
            const wdata = this.wasm.strToWasm(str);
            // Allocate the encoder buffers.
            const bytes = this.exports.mte_wasm_enc_buff_bytes_b64(this.encoder.off, wdata.used);
            const encBuff = this.wasm.malloc(bytes);
            const eOff = this.wasm.newInt();
            const eBytes = this.wasm.newInt();
            // Encode.
            const ret = this.exports.mte_wasm_enc_encode_b64(this.encoder.off, this.instance, wdata.off, wdata.used, encBuff.off, eOff.off, eBytes.off);
            if (ret != MteStatus.mte_status_success) {
                this.wasm.free(wdata);
                this.wasm.free(encBuff);
                this.wasm.free(eOff);
        ...
        // Initialize the base.
        this.initBase(drbgE, tokBytes, verifiersE, MteCiphers.mte_ciphers_none, MteHashes.mte_hashes_none);
        // Get the encoder size.
        const bytes = this.exports.mte_wasm_enc_state_bytes(drbgE, tokBytes, verifiersE);
        if (bytes == 0) {
        ...
        const stat = this.exports.mte_wasm_enc_state_init(this.encoder.off, drbgE, tokBytes, verifiersE);
    ...
    static fromdefault(wasm) {
        const base = new MteBase(wasm);
        return new MteEnc(wasm, base.getDefaultDrbg(), base.getDefaultTokBytes(), base.getDefaultVerifiers());
    }
}
...
export class MteDec extends MteBase {
    ...
    constructor(wasm, drbg, tokBytes, verifiers, tWindow, sWindow) {
        // Super.
        super(wasm);
        /** Decode values. */
        this.encTs = { ts: 0, upper: 0 };
        this.decTs = { ts: 0, upper: 0 };
        this.msgSkipped = 0;
        /** Destruct. The WASM memory will be freed and the object can no longer be
         *  used. */
        this.destruct = () => {
        ...
        this.instantiate = (ps) => {
            ...
            const psWasm = this.wasm.strToWasm(ps);
            // Instantiate.
            const ret = this.exports.mte_wasm_dec_instantiate(this.decoder.off, this.instance, this.instance, psWasm.off, psWasm.used);
            // Free the personalization string.
            this.wasm.free(psWasm);
            // Return the status.
            return ret;
        ...
        this.saveState = () => {
            // Save to the save memory. Return the buffer.
            const status = this.exports.mte_dec_state_save(this.decoder.off, this.saved.off);
            return status == MteStatus.mte_status_success ?
                new Uint8Array(this.saved.buff) : null;
        };
        /** Returns the saved state, Base64 encoded. On error, null is returned. */
        this.saveStateB64 = () => {
            // Save to the save memory. Return the Base64-encoded string.
            const status = this.exports.mte_wasm_dec_state_save_b64(this.decoder.off, this.saved64.off);
            return status == MteStatus.mte_status_success ?
                this.wasm.wasmToStr(this.saved64) : null;
        };
        /** Restore a saved state, which must be the same length as was returned
        ...
        this.restoreStateB64 = (saved) => {
            ...
            const stateWasm = this.wasm.strToWasm(saved);
            // Restore.
            const status = this.exports.mte_wasm_dec_state_restore_b64(this.decoder.off, stateWasm.off);
            // Free the WASM memory.
            this.wasm.free(stateWasm);
            // Return status.
            return status;
        ...
        this.decode = (encoded) => {
            ...
            const bytes = this.exports.mte_dec_buff_bytes(this.decoder.off, encoded.length);
            ...
            // Decode.
            const ret = this.exports.mte_wasm_dec_decode(this.decoder.off, this.instance, wencoded.off, encoded.length, decBuff.off, dOff.off, dBytes.off, et.off, dt.off, ms.off);
         ...
         *  and status. */
        this.decodeB64 = (encoded) => {
            // Copy the Base64 to the WASM memory.
            const wencoded = this.wasm.strToWasm(encoded);
            // Allocate the decoder buffers.
            const bytes = this.exports.mte_wasm_dec_buff_bytes_b64(this.decoder.off, wencoded.used);
            const decBuff = this.wasm.malloc(bytes);
            const dOff = this.wasm.newInt();
            const dBytes = this.wasm.newInt();
            const et = this.wasm.newInt64();
            ...
            const ms = this.wasm.newInt();
            // Decode.
            const ret = this.exports.mte_wasm_dec_decode_b64(this.decoder.off, this.instance, wencoded.off, wencoded.used, decBuff.off, dOff.off, dBytes.off, et.off, dt.off, ms.off);
            if (this.statusIsError(ret)) {
                this.wasm.free(wencoded);
                this.wasm.free(decBuff);
                this.wasm.free(dOff);
        ...
        const bytes = this.exports.mte_wasm_dec_state_bytes(drbgE, tokBytes, verifiersE);
        if (bytes == 0) {
        ...
        const stat = this.exports.mte_wasm_dec_state_init(this.decoder.off, drbgE, tokBytes, verifiersE, tWindow, sWindow);
        if (stat != MteStatus.mte_status_success) {
            this.wasm.free(this.decoder);
            throw new RangeError("MteDec: Invalid options.");
        }
    ...
    static fromdefault(wasm, tWindow = 0, sWindow = 0) {
        const base = new MteBase(wasm);
        return new MteDec(wasm, base.getDefaultDrbg(), base.getDefaultTokBytes(), base.getDefaultVerifiers(), tWindow, sWindow);
    }
}
...
export class MteMkeEnc extends MteBase {
    ...
    constructor(wasm, drbg, tokBytes, verifiers, cipher, hash) {
        // Super.
        super(wasm);
        /** Destruct. The WASM memory will be freed and the object can no longer be
         *  used. */
        ...
        this.instantiate = (ps) => {
            ...
            const psWasm = this.wasm.strToWasm(ps);
            // Instantiate.
            const ret = this.exports.mte_wasm_mke_enc_instantiate(this.encoder.off, this.instance, this.instance, psWasm.off, psWasm.used);
            // Free the personalization string.
            this.wasm.free(psWasm);
            // Return the status.
            return ret;
        ...
        this.saveState = () => {
            // Save to the save memory. Return the buffer.
            const status = this.exports.mte_mke_enc_state_save(this.encoder.off, this.saved.off);
            return status == MteStatus.mte_status_success ?
                new Uint8Array(this.saved.buff) : null;
        };
        /** Returns the saved state, Base64 encoded. On error, null is returned. */
        this.saveStateB64 = () => {
            // Save to the save memory. Return the Base64-encoded string.
            const status = this.exports.mte_wasm_mke_enc_state_save_b64(this.encoder.off, this.saved64.off);
            return status == MteStatus.mte_status_success ?
                this.wasm.wasmToStr(this.saved64) : null;
        };
        /** Restore a saved state, which must be the same length as was returned
        ...
        this.restoreState = (saved) => {
            ...
            this.wasm.arrToOffLen(saved, this.saved.off, saved.length);
            // Restore.
            return this.exports.mte_mke_enc_state_restore(this.encoder.off, this.saved.off);
        };
        /** Restore a saved state, which must be the same length as was returned
         *  from the saveStateB64() call. Returns the status. */
        this.restoreStateB64 = (saved) => {
            ...
            const stateWasm = this.wasm.strToWasm(saved);
            // Restore.
            const status = this.exports.mte_wasm_mke_enc_state_restore_b64(this.encoder.off, stateWasm.off);
            // Free the WASM memory.
            this.wasm.free(stateWasm);
            // Return status.
            return status;
        ...
        this.encode = (data) => {
            ...
            const wdata = this.wasm.arrToWasm(data);
            // Allocate the encoder buffers.
            const bytes = this.exports.mte_mke_enc_buff_bytes(this.encoder.off, data.length);
            const encBuff = this.wasm.malloc(bytes);
            const eOff = this.wasm.newInt();
            const eBytes = this.wasm.newInt();
            // Encode.
            const ret = this.exports.mte_wasm_mke_enc_encode(this.encoder.off, this.instance, wdata.off, data.length, encBuff.off, eOff.off, eBytes.off);
            if (ret != MteStatus.mte_status_success) {
                this.wasm.free(wdata);
                this.wasm.free(encBuff);
                this.wasm.free(eOff);
        ...
        this.encodeB64 = (data) => {
            ...
            const wdata = this.wasm.arrToWasm(data);
            // Allocate the encoder buffers.
            const bytes = this.exports.mte_wasm_mke_enc_buff_bytes_b64(this.encoder.off, data.length);
            const encBuff = this.wasm.malloc(bytes);
            const eOff = this.wasm.newInt();
            const eBytes = this.wasm.newInt();
            // Encode.
            const ret = this.exports.mte_wasm_mke_enc_encode_b64(this.encoder.off, this.instance, wdata.off, data.length, encBuff.off, eOff.off, eBytes.off);
            if (ret != MteStatus.mte_status_success) {
                this.wasm.free(wdata);
                this.wasm.free(encBuff);
                this.wasm.free(eOff);
        ...
        this.encodeStr = (str) => {
            ...
            const wdata = this.wasm.strToWasm(str);
            // Allocate the encoder buffers.
            const bytes = this.exports.mte_mke_enc_buff_bytes(this.encoder.off, wdata.used);
            const encBuff = this.wasm.malloc(bytes);
            const eOff = this.wasm.newInt();
            const eBytes = this.wasm.newInt();
            // Encode.
            const ret = this.exports.mte_wasm_mke_enc_encode(this.encoder.off, this.instance, wdata.off, wdata.used, encBuff.off, eOff.off, eBytes.off);
            if (ret != MteStatus.mte_status_success) {
                this.wasm.free(wdata);
                this.wasm.free(encBuff);
                this.wasm.free(eOff);
        ...
        this.encodeStrB64 = (str) => {
            ...
            const wdata = this.wasm.strToWasm(str);
            // Allocate the encoder buffers.
            const bytes = this.exports.mte_wasm_mke_enc_buff_bytes_b64(this.encoder.off, wdata.used);
            const encBuff = this.wasm.malloc(bytes);
            const eOff = this.wasm.newInt();
            const eBytes = this.wasm.newInt();
            // Encode.
            const ret = this.exports.mte_wasm_mke_enc_encode_b64(this.encoder.off, this.instance, wdata.off, wdata.used, encBuff.off, eOff.off, eBytes.off);
            if (ret != MteStatus.mte_status_success) {
                this.wasm.free(wdata);
                this.wasm.free(encBuff);
                this.wasm.free(eOff);
        ...
        this.startEncrypt = () => {
            return this.exports.mte_mke_enc_encrypt_start(this.encoder.off, this.chunk.off);
        };
        ...
        this.encryptChunk = (data) => {
            ...
            const wdata = this.wasm.arrToWasm(data);
            // Encrypt.
            const stat = this.exports.mte_wasm_mke_enc_encrypt_chunk(this.encoder.off, this.chunk.off, wdata.off, data.length, wdata.off);
        ...
        this.finishEncrypt = () => {
            ...
            // Finish the session.
            const ret = this.exports.mte_wasm_mke_enc_encrypt_finish(this.encoder.off, this.chunk.off, this.instance, rOff.off, rBytes.off);
            if (ret != MteStatus.mte_status_success) {
                this.wasm.free(rOff);
        ...
        // Get the encoder size.
        const bytes = this.exports.mte_wasm_mke_enc_state_bytes(drbgE, tokBytes, verifiersE, cipherE, hashE);
        if (bytes == 0) {
        ...
        this.encoder = wasm.malloc(bytes);
        // Initialize the encoder state.
        const stat = this.exports.mte_wasm_mke_enc_state_init(this.encoder.off, drbgE, tokBytes, verifiersE, cipherE, hashE);
        if (stat != MteStatus.mte_status_success) {
            throw new RangeError("MteMkeEnc: Invalid options.");
        }
        // Saved state.
        ...
        this.saved64 = wasm.malloc(this.exports.mte_wasm_mke_enc_save_bytes_b64(this.encoder.off));
        // Chunk-based encryption state.
        this.chunk = wasm.malloc(this.exports.mte_mke_enc_encrypt_state_bytes(this.encoder.off));
    }
    /** Create an encoder using default options. */
    static fromdefault(wasm) {
        const base = new MteBase(wasm);
        return new MteMkeEnc(wasm, base.getDefaultDrbg(), base.getDefaultTokBytes(), base.getDefaultVerifiers(), base.getDefaultCipher(), base.getDefaultHash());
    }
}
...
export class MteMkeDec extends MteBase {
    ...
    constructor(wasm, drbg, tokBytes, verifiers, cipher, hash, tWindow, sWindow) {
        // Super.
        super(wasm);
        /** Decode values. */
        this.encTs = { ts: 0, upper: 0 };
        ...
        this.instantiate = (ps) => {
            ...
            const psWasm = this.wasm.strToWasm(ps);
            // Instantiate.
            const ret = this.exports.mte_wasm_mke_dec_instantiate(this.decoder.off, this.instance, this.instance, psWasm.off, psWasm.used);
            // Free the personalization string.
            this.wasm.free(psWasm);
            // Return the status.
            return ret;
        ...
        this.saveState = () => {
            // Save to the save memory. Return the buffer.
            const status = this.exports.mte_mke_dec_state_save(this.decoder.off, this.saved.off);
            return status == MteStatus.mte_status_success ?
                new Uint8Array(this.saved.buff) : null;
        };
        /** Returns the saved state, Base64 encoded. On error, null is returned. */
        this.saveStateB64 = () => {
            // Save to the save memory. Return the Base64-encoded string.
            const status = this.exports.mte_wasm_mke_dec_state_save_b64(this.decoder.off, this.saved64.off);
            return status == MteStatus.mte_status_success ?
                this.wasm.wasmToStr(this.saved64) : null;
        };
        /** Restore a saved state, which must be the same length as was returned
        ...
        this.restoreState = (saved) => {
            ...
            this.wasm.arrToOffLen(saved, this.saved.off, saved.length);
            // Restore.
            return this.exports.mte_mke_dec_state_restore(this.decoder.off, this.saved.off);
        };
        /** Restore a saved state, which must be the same length as was returned
         *  from the saveStateB64() call. Returns the status. */
        this.restoreStateB64 = (saved) => {
            ...
            const stateWasm = this.wasm.strToWasm(saved);
            // Restore.
            const status = this.exports.mte_wasm_mke_dec_state_restore_b64(this.decoder.off, stateWasm.off);
            // Free the WASM memory.
            this.wasm.free(stateWasm);
            // Return status.
            return status;
        ...
        this.decode = (encoded) => {
            ...
            const wencoded = this.wasm.arrToWasm(encoded);
            // Allocate the decoder buffers.
            const bytes = this.exports.mte_mke_dec_buff_bytes(this.decoder.off, encoded.length);
            if (bytes == 0) {
                this.wasm.free(wencoded);
            ...
            const ms = this.wasm.newInt();
            // Decode.
            const ret = this.exports.mte_wasm_mke_dec_decode(this.decoder.off, this.instance, wencoded.off, encoded.length, decBuff.off, dOff.off, dBytes.off, et.off, dt.off, ms.off);
            if (this.statusIsError(ret)) {
                this.wasm.free(wencoded);
                this.wasm.free(decBuff);
                this.wasm.free(dOff);
        ...
        this.decodeB64 = (encoded) => {
            ...
            const wencoded = this.wasm.strToWasm(encoded);
            // Allocate the decoder buffers.
            const bytes = this.exports.mte_wasm_mke_dec_buff_bytes_b64(this.decoder.off, wencoded.used);
            const decBuff = this.wasm.malloc(bytes);
            const dOff = this.wasm.newInt();
            const dBytes = this.wasm.newInt();
            const et = this.wasm.newInt64();
            ...
            const ms = this.wasm.newInt();
            // Decode.
            const ret = this.exports.mte_wasm_mke_dec_decode_b64(this.decoder.off, this.instance, wencoded.off, wencoded.used, decBuff.off, dOff.off, dBytes.off, et.off, dt.off, ms.off);
            if (this.statusIsError(ret)) {
                this.wasm.free(wencoded);
                this.wasm.free(decBuff);
                this.wasm.free(dOff);
        ...
        this.decryptChunk = (encrypted) => {
            ...
            // Decrypt.
            const status = this.exports.mte_wasm_mke_dec_decrypt_chunk(this.decoder.off, this.chunk.off, wencr.off, encrypted.length, wdecr.off, dBytes.off);
            // Copy to the return buffer.
            const decBytes = this.wasm.wasmToInt(dBytes.off);
        ...
        this.finishDecrypt = () => {
            ...
            const dt = this.wasm.newInt64();
            const ms = this.wasm.newInt();
            const ret = this.exports.mte_wasm_mke_dec_decrypt_finish(this.decoder.off, this.chunk.off, this.instance, dOff.off, dBytes.off, et.off, dt.off, ms.off);
            if (this.statusIsError(ret)) {
                this.wasm.free(dOff);
                this.wasm.free(dBytes);
                this.wasm.free(et);
        ...
        this.initBase(drbgE, tokBytes, verifiersE, cipherE, hashE);
        // Get the decoder size.
        const bytes = this.exports.mte_wasm_mke_dec_state_bytes(drbgE, tokBytes, verifiersE, cipherE, hashE);
        if (bytes == 0) {
        ...
        const stat = this.exports.mte_wasm_mke_dec_state_init(this.decoder.off, drbgE, tokBytes, verifiersE, cipherE, hashE, tWindow, sWindow);
        if (stat != MteStatus.mte_status_success) {
            throw new RangeError("MteMkeDec: Invalid options.");
        }
        // Saved state.
        ...
        this.saved64 = wasm.malloc(this.exports.mte_wasm_mke_dec_save_bytes_b64(this.decoder.off));
        // Chunk-based decryptor state.
        this.chunk = wasm.malloc(this.exports.mte_mke_dec_decrypt_state_bytes(this.decoder.off));
    ...
    static fromdefault(wasm, tWindow = 0, sWindow = 0) {
        const base = new MteBase(wasm);
        return new MteMkeDec(wasm, base.getDefaultDrbg(), base.getDefaultTokBytes(), base.getDefaultVerifiers(), base.getDefaultCipher(), base.getDefaultHash(), tWindow, sWindow);
    }
}
...
export class MteSdrAbs {
     ...
     */
    constructor(enc, dec, sdrDir) {
        this.entropy = new Uint8Array(0);
        /** Memory files. */
        this.memFiles = new Map();
         ...
         */
        this.writeData = (name, data, toMemory = false) => {
         ...
         *  on I/O error or MTE error.
         */
        this.writeString = (name, str, toMemory = false) => {
            // Get the timestamp. XOR the nonce into it.
            const ts = this.implGetTimestamp();
            const nonce = new Uint8Array(this.nonce.length);
            for (let i = 0; i < nonce.length; ++i) {
         ...
         *  an exception.
         */
        this.implWriteFile = (dir, file, contents) => {
            dir;
            file;
            contents;
...
export class MteSdrCookie extends MteSdrAbs {
     ...
     *  outside this object as this object will change their states.
     */
    constructor(enc, dec, sdrDir, attrs) {
        // Super.
        ...
        this.implListFiles = (dir) => {
            ...
            // the prefix.
            return document.cookie.split(';').filter((item) => item.trim().startsWith(name)).map((item) => item.split('=')[0].trim().slice(name.length));
        };
        /** Reads a file. Returns the file contents. Throws an exception on failure.
         */
        this.implReadFile = (dir, file) => {
            ...
            const cookie = document.cookie.split(';').filter((item) => item.trim().startsWith(name));
            if (cookie.length != 1) {
     ...
     */
    static fromdefault(wasm, sdrDir, attrs) {
        return new MteSdrCookie(MteMkeEnc.fromdefault(wasm), MteMkeDec.fromdefault(wasm), sdrDir, attrs);
    }
}
...
export class MteSdrStorage extends MteSdrAbs {
     ...
     *  outside this object as this object will change their states.
     */
    constructor(enc, dec, sdrDir, useLocal) {
        // Super.
        super(enc, dec, sdrDir);
        /** Returns a list of file basenames in a directory. Throws an exception on
         *  failure.
     ...
     */
    static fromdefault(wasm, sdrDir, useLocal) {
        return new MteSdrStorage(MteMkeEnc.fromdefault(wasm), MteMkeDec.fromdefault(wasm), sdrDir, useLocal);
    }
}
/** Class MteRandom
 *
...
export var MteKyberStrength;
(function (MteKyberStrength) {
    MteKyberStrength[MteKyberStrength["none"] = 0] = "none";
    MteKyberStrength[MteKyberStrength["K512"] = 512] = "K512";
    MteKyberStrength[MteKyberStrength["K768"] = 768] = "K768";
    MteKyberStrength[MteKyberStrength["K1024"] = 1024] = "K1024";
})(MteKyberStrength || (MteKyberStrength = {}));
export var MteKyberStatus;
(function (MteKyberStatus) {
    MteKyberStatus[MteKyberStatus["success"] = 0] = "success";
    MteKyberStatus[MteKyberStatus["invalidStrength"] = -1] = "invalidStrength";
    MteKyberStatus[MteKyberStatus["entropyFail"] = -2] = "entropyFail";
    MteKyberStatus[MteKyberStatus["invalidPubKey"] = -3] = "invalidPubKey";
    MteKyberStatus[MteKyberStatus["invalidPrivKey"] = -4] = "invalidPrivKey";
    MteKyberStatus[MteKyberStatus["memoryFail"] = -5] = "memoryFail";
    MteKyberStatus[MteKyberStatus["invalidCipherText"] = -6] = "invalidCipherText";
})(MteKyberStatus || (MteKyberStatus = {}));
export class MteKyber {
    /** Constructor which needs no parameters. */
    constructor(wasm, strength) {
        /** Sizes. */
        this.publicKeySize = 0;
        this.privateKeySize = 0;
        this.minEntropySize = 0;
        this.maxEntropySize = 0;
        this.encryptedSize = 0;
        this.secretSize = 0;
        /** The private key. */
        this.privateKey = null;
        /* Implementation. */
        this.myEntropyCb = null;
        this.myEntropy = null;
        ...
        this.createKeypair = () => {
            let status = MteKyberStatus.success;
            ...
            // Create the key pair
            status = this.exports.mte_wasm_kyber_create_keypair(wPrivate.off, wPrivateBytes.off, wPublic.off, wPublicBytes.off, this.instance);
         ...
         *  with the status. */
        this.createSecret = (peerPublicKey) => {
            // Copy the data to the WASM memory.
            ...
            // Create the secret.
            const rc = this.exports.mte_wasm_kyber_create_secret(wPeerPubKey.off, peerPublicKey.length, wSecret.off, wSecretBytes.off, wEncrypted.off, wEncryptedBytes.off, this.instance);
        ...
        this.decryptSecret = (encrypted) => {
            ...
            this.wasm.intToWasm(wSecretBytes.off, this.secretSize);
            // Decrypt the secret.
            const rc = this.exports.mte_wasm_kyber_decrypt_secret(wPrivateKey.off, this.privateKey.length, wEncrypted.off, encrypted.length, wSecret.off, wSecretBytes.off);
            // Free the wasm key resources
        ...
        /** The entropy callback. */
        this.defaultCallback = (context, entropy, entropyBytes, minEntropyBytes, maxEntropyBytes) => {
            // Get the MTE instance.
            const myInstance = MteKyber.instances[context];
            // Call the override callback if set.
            if (myInstance.myEntropyCb !== null) {
                return myInstance.myEntropyCb.entropyCallback(entropy, entropyBytes, minEntropyBytes, maxEntropyBytes);
            }
...
MteKyber.strength = MteKyberStrength.none;
/** Zeroize the given byte array. */
MteKyber.zeroize = (dest) => {
...
export class MteWasm {
    constructor() {
        /** Callbacks. */
        this.kyberCallback = null;
        this.entropyCallback = null;
        ...
        this.malloc = (bytes) => {
            ...
            for (let i = 0; i < count; ++i) {
                ...
                if (!this.blocks[i].inUse && this.blocks[i].bytes >= bytes) {
                    ...
                    if (this.blocks[i].bytes > bytes) {
                        this.blocks.splice(i + 1, 0, new MteHeapBlock(this.blocks[i].off + bytes, this.blocks[i].bytes - bytes));
                        this.blocks[i].bytes = bytes;
                    }
                    // Return a memory object describing the block.
                    const mteMem = new MteMem(this.blocks[i].off, new Uint8Array(mem.buffer, this.blocks[i].off, bytes));
            ...
            for (let i = 0; i < count; ++i) {
                if (this.blocks[i].inUse) {
                    this.blocks[i].mteMem.buff = new Uint8Array(mem.buffer, this.blocks[i].off, this.blocks[i].bytes);
                }
            }
        ...
        this.arrToOffLen = (arr, off, bytes) => {
            // Overlay and copy.
            const overlay = this.wasmOverlay(off, bytes);
            for (let i = 0; i < bytes; ++i) {
                overlay[i] = arr[i];
        ...
        this.kyberCallbackWasm = (context, entropy, entropyBytes, minEntropyBytes, maxEntropyBytes) => {
            if (this.kyberCallback === null) {
                throw new TypeError("Missing Kyber callback.");
            }
            return this.kyberCallback(context, entropy, entropyBytes, minEntropyBytes, maxEntropyBytes);
        };
        /** The entropy callback for WASM. Calls the registered callback. */
        this.entropyCallbackWasm = (context, minEntropy, minLength, maxLength, entropyInput, eiBytes) => {
            if (this.entropyCallback === null) {
                throw new TypeError("Missing entropy callback.");
            }
            return this.entropyCallback(context, minEntropy, minLength, maxLength, entropyInput, eiBytes);
        };
        /** The nonce callback for WASM. Calls the registered callback. */
        this.nonceCallbackWasm = (context, minLength, maxLength, nonce, nBytes) => {
        ...
        this.timestampCallbackWasm = (context, ts) => {
...
class MteWasmData {
    ...
    constructor() {
        ...
        while (binIndex < noPad) {
            // Get the quad.
            b0ch = MteWasmData.wasmB64.charCodeAt(b64Index);
            ++b64Index;
            b1ch = MteWasmData.wasmB64.charCodeAt(b64Index);
            ++b64Index;
            b2ch = MteWasmData.wasmB64.charCodeAt(b64Index);
            ++b64Index;
            b3ch = MteWasmData.wasmB64.charCodeAt(b64Index);
            ++b64Index;
            ...
            ++binIndex;
            this.wasmArr[binIndex] = ((b2 & 0x03) << 6) | (b3);
            ++binIndex;
        }
